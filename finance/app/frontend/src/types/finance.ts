...
export interface Transaction {
  ...
  amountMinor: number; currency: string; description: string | null; occurredAt: string; categoryId: string | null; projectId?: string | null;
}
...
export interface RecurringRule { id:string; accountId:string; type:'income'|'expense'; amountMinor:number; currency:string; frequency:string; dayOfMonth?:number|null; startDate:string; endDate?:string|null; categoryId?:string|null; projectId?:string|null; description:string|null; active:boolean; }
