...
describe('Transactions details', () => {
  it('shows receipt positions and hides DPS refresh when the flag is disabled', () => {
    render(<Transactions transactions={[{
      id: 'tx-1', ownerId: 'owner', ownerName: 'Антон', accountId: 'card', relatedAccountId: null, type: 'expense', amountMinor: 12300, currency: 'UAH', description: 'Магазин', occurredAt: '2026-08-31T12:00:00.000Z', categoryId: null,
    ...
    expect(screen.getAllByText('Антон').length).toBeGreaterThan(0);
