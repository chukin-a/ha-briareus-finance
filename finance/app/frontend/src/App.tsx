...
export default function App() {
  ...
  else if(page==='dashboard') content=<Dashboard accounts={accounts} transactions={transactions} categories={categories} period={period} range={customRange} onPeriodChange={setPeriod} onRangeChange={setCustomRange} onNavigate={setPage} onSettings={()=>setPage('settings')} onCreateTransaction={()=>{setQuickTransaction(true);setPage('transactions')}}/>;
