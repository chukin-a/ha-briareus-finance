...
import { TaxReceiptService } from '../application/tax-receipt.service';
import { CreateTransactionDto, TransactionQueryDto, UpdateTransactionDto } from './transaction.dto';
@Controller('transactions')
export class TransactionsController {
  constructor(private readonly finance: FinanceService, private readonly taxReceipts: TaxReceiptService) {}
  ...
  @Post('receipts/tax-lookup') lookupTaxReceipt(@Body() body: Record<string, unknown>) { return this.taxReceipts.lookup(body); }
}
