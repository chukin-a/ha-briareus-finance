...
export class TransactionsController {
  ...
  @Post() async create(@Headers() headers: Record<string, string | string[] | undefined>, @Body() body: CreateTransactionDto) { return this.finance.createTransaction(body, await this.finance.getCurrentUser(headers)); }
